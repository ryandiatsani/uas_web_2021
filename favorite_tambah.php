<?php 
           ...
           if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $sql = "INSERT into favorit VALUES(NULL,'$id')";
...
<div class="row m-5 p-5">
      ...
      <div class="col-8">
         <h2>Apakah anda yakin ingin menambahkan ini ke daftar favorite?</h2>
      ...
      <div>
        <input type="submit" class="btn btn-danger" value="Tambahkan ke favorite"><br>
